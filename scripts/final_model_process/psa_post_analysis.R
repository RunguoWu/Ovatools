...
pa100v101_1001_utiben_byAgeOnly_niceUS_adj_pop0

pa100v101_1001_utiben_byAgeOnly_niceUS_adj_pop

# Scenario Analyses -------------------------------------------------------
adj_pop <- TRUE # in the study population or in the CA125 record population
...
#> change surgery related disutility in the first year----
fn_pa_master(dect0="decitree100", dect1="decitree101",
             accuracy_file= "byAgeOnly_niceUS", adj_pop=adj_pop, 
             surg_disu_adj = -0.01) # futher reduce 0.01 on top of -0.04
fn_pa_master(dect0="decitree100", dect1="decitree101",
             accuracy_file= "byAgeOnly_niceUS", adj_pop=adj_pop, 
             surg_disu_adj = -0.02)
fn_pa_master(dect0="decitree100", dect1="decitree101",
...
#> 15% complication with additional cost----
fn_pa_master(dect0="decitree100", dect1="decitree101",
             accuracy_file= "byAgeOnly_niceUS", adj_pop=adj_pop, complication = TRUE)
fn_pa_master(dect0="decitree101", dect1="decitree110",
             accuracy_file= "byAgeOnly_niceUS", adj_pop=adj_pop, complication = TRUE)
