...
link_markov <- function(he_ova, comp, 
                        ...
                        FP_data, disuti, uti_ben, extra_cost, complication,
                        surg_prob_adj=0, surg_disu_adj=0
                        ){
  ...
  dt <- dt %>% 
    ...
    mutate(
      ...
      FP_0_disuti = FP_0_surg * (FP_data$surg_disu + surg_disu_adj),
      FP_1_disuti = FP_1_surg * (FP_data$surg_disu + surg_disu_adj),
  ...
  if (complication){
    # assume 15% complication happens to FP surgery 
    # no impact on QoL
    # additional £2209
    dt <- dt %>%
      mutate(
        complication_cost_0 = FP_0_surg * 0.15 * 2209,
        complication_cost_1 = FP_1_surg * 0.15 * 2209,
        
        cost_tot_0 = cost_tot_0 + complication_cost_0,
        cost_tot_1 = cost_tot_1 + complication_cost_1,
        cost_tot_uo_1 = cost_tot_uo_1 + complication_cost_1,
        
        cost_disc_tot_0 = cost_disc_tot_0 + complication_cost_0,
        cost_disc_tot_1 = cost_disc_tot_1 + complication_cost_1,
        cost_disc_tot_uo_1 = cost_disc_tot_uo_1 + complication_cost_1
      )
  }
